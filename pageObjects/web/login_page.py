...
class LoginPage(CommonPage):
    ...
    def go_to(self):
        ...
        to load, performs accessibility analysis, and verifies that the username field,
        password field, and sign-in button are visible.
        """
    ...
    def valid_login(self, username, password):
        ...
        This method waits for the username and password fields to be visible,
        fills them with the provided credentials, clicks the sign-in button,
        and waits for the network to be idle after login.
        """
        self.page.locator(self.locators["userName"]).wait_for(state="visible")
